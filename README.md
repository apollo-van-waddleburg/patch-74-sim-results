...
### Files and Outputs
* [configs](https://github.com/apollo-van-waddleburg/patch-74-sim-results/blob/main/configs) contains the original csvs and 8-player comp configurations for generating these outputs.
* [outputs](https://github.com/apollo-van-waddleburg/patch-74-sim-results/blob/main/outputs) contains simulated results for all of these comps in `csv` and `html` formats.
